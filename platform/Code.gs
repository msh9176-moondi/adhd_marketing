...
const CONFIGS = {
  ...
  goalAgreements: { name:'목표합의서', keys:['id','coacheeId','coachId','coacheeName','coachName','topic','desiredOutcome','actionPlan','evaluationMethod','currentScore','targetScore','coacheeConsent','coachConsent','agreedAt'],                                    json:[] },
